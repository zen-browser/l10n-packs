...
zen-look-and-feel-themed-toolbar = 
    .label = جعل شريط الأدوات موضوع بلون اللكنة
...
zen-vertical-tabs-show-bottom-border = 
    .label = إظهار الحدود للأيقونات السفلية
...
zen-look-and-feel-buttons-header = نمط الزر
zen-look-and-feel-buttons-description = اختر نمط الأزرار التي تريد رؤيتها
...
zen-key-unsafed = اختصار غير محفوظ! الرجاء تأمين ذلك بالنقر على مفتاح "الهروب من الخدمة" بعد إعادة الكتابة.
...
zen-vertical-tabs-newtab-under-last-tab = 
    .label = إظهار زر التبويب الجديد تحت علامة التبويب الأخيرة
...
zen-theme-marketplace-updates-fail = تعذر العثور على أي تحديثات!
...
zen-settings-workspaces-display-as-icon-strip = 
    .label = عرض مساحات العمل كشريط أيقونات
...
zen-settings-workspaces-hide-deactivated-workspaces = 
    .label = إخفاء مساحات العمل المعطلة
