...
pane-zen-marketplace-title = متجر السمة
zen-look-and-feel-legacy-toolbar = 
    .label = استخدم موضع شريط الأدوات القديم. يتطلب إعادة التشغيل!
zen-theme-marketplace-link = Visit Store
zen-dark-theme-styles-header = أنماط المظهر المظلم
zen-dark-theme-styles-description = قم بتخصيص المظهر الداكن حسب رغبتك
zen-dark-theme-styles-amoled = أموليد الأسود
zen-dark-theme-styles-default = المظهر المظلم الافتراضي
zen-dark-theme-styles-colorful = المظهر المظلم الملون
