...
zen-workspaces-delete-workspace-title = Supprimer cet espace ?
zen-workspaces-delete-workspace-body = Êtes-vous sûr de vouloir supprimer cet espace ? Cette action est irréversible.
