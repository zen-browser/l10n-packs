...
zen-look-and-feel-themed-toolbar = 
    .label = Faire de la barre d'outils un thème avec la couleur d'accentuation
pane-zen-side-panels-title = Panneaux Web latéraux
zen-side-panels-header = Paramètres généraux pour les panneaux web
zen-side-panels-description = Augmentez la productivité en ayant plusieurs vues à la fois!
...
zen-vertical-tabs-newtab-under-last-tab = 
    .label = Afficher le bouton du nouvel onglet sous le dernier onglet
