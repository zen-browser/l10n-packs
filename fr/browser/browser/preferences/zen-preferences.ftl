...
zen-glance-trigger-mantain-click = 
    .label = Maintenir le Clic (Prochainement !)
...
zen-key-unsafed = Raccourci non sauvegardé ! Veuillez le sécuriser en cliquant sur la touche "Échap" après le ré-écrire.
