...
zen-vertical-tabs-show-bottom-border = 
    .label = Vis ramme på de nederste ikoner
...
zen-pinned-tab-manager-description = Administrer ekstra adfærd for fastgjorte faner
...
zen-settings-workspaces-allow-pinned-tabs-for-different-workspaces = 
    .label = Lad arbejdsområder have deres egne fastgjorte faner
...
zen-theme-marketplace-updates-success = Tema blev opdateret
zen-theme-marketplace-updates-fail = Ingen opdateringer fundet!
zen-theme-marketplace-toggle-enabled-button = 
    .title = Deaktiver tema
...
zen-settings-workspaces-force-container-tabs-to-workspace = 
    .label = Skift til arbejdsområdet, hvor beholderen er sat som standard, når du åbner beholderfaner
...
zen-dark-theme-styles-amoled = Nattema
