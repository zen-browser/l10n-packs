...
zen-side-panels-close-on-blur = 
    .label = Luk panelet, når det mister fokus, hvis ikke fastgjort
...
zen-pinned-tab-manager-close-shortcut-behavior-label = Adfærd for 'Luk fane'-genvejen
zen-pinned-tab-manager-reset-unload-switch-close-shortcut-option = 
    .label = Nulstil URL, deaktiver og skift til næste fane
zen-pinned-tab-manager-unload-switch-close-shortcut-option = 
    .label = Deaktiver og skift til næste fane
...
zen-settings-workspaces-description = Med arbejdsområder kan du have flere browsersessioner på én gang!
...
zen-reader-mode-toggle-shortcut-other = Læsetilstand til/fra
zen-picture-in-picture-toggle-shortcut = Billede-i-billede til/fra
...
zen-key-wr-toggle-capture-sequence-cmd = WR-optagelsessekvens til/fra
...
zen-web-panel-shortcut-toggle = Vis/skjul webpanel
