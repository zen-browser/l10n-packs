...
zen-pinned-tab-manager-close-shortcut-behavior-header = Close Tab Shortcut Behavior
zen-pinned-tab-manager-close-shortcut-behavior-description = Choose the behavior of the close tab shortcut
zen-pinned-tab-manager-reset-close-shortcut-enabled =
    .label = Reset pinned tab to its originally pinned URL
zen-pinned-tab-manager-unload-close-shortcut-enabled =
    .label = Unload tab (doesn't work if change to next available tab is unchecked)
zen-pinned-tab-manager-change-close-shortcut-enabled =
    .label = Change to next available tab
zen-pinned-tab-manager-close-close-shortcut-enabled =
    .label = Close tab
