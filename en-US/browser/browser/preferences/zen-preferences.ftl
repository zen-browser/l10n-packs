...
zen-theme-marketplace-remove-all-mods-success = All mods removed successfully
zen-theme-marketplace-remove-all-mods-failure = An error occurred while removing all mods
