...
zen-settings-workspaces-allow-pinned-tabs-for-different-workspaces = 
    .label = 允許工作區有自訂的固定分頁
zen-key-unsafed = 快捷鍵未儲存！請重新輸入並按下 "Escape" 鍵來儲存快捷鍵
...
zen-search-focus-shortcut = 聚焦搜尋
zen-search-focus-shortcut-alt = 聚焦搜尋 (備用)
...
zen-search-find-again-shortcut = 再次尋找
zen-search-find-again-shortcut-prev = 尋找上一個
