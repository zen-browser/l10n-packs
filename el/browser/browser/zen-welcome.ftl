...
welcome-dialog-get-started = Ας αρχίσουμε
welcome-dialog-import = 😍 Φέρτε τα αγαπημένα σας στον { -brand-short-name }
welcome-dialog-import-subtext = Παραλαβή από εκεί που σταματήσατε στο τελευταίο σας πρόγραμμα περιήγησης
welcome-dialog-import-action = Εισαγωγή των δεδομένων σας
welcome-dialog-theme = Φτιάξτε τον εαυτό σας στο σπίτι
welcome-dialog-theme-subtext = Προσαρμόστε την εμπειρία σας με την αγαπημένη σας εμφάνιση!
welcome-dialog-theme-header-1 = Επιλέξτε το τέλειο χρώμα
welcome-dialog-theme-header-2 = Επιλέξτε το θέμα σας
welcome-dialog-search = 🔍 Επιλέξτε μια μηχανή αναζήτησης
welcome-dialog-search-subtext = Επιλέξτε την μηχανή αναζήτησης που προτιμάτε για να προσαρμόσετε την εμπειρία περιήγησης!
