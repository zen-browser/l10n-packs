...
zen-look-and-feel-use-workspace-colors = 
    .label = Χρήση χρωμάτων χώρου εργασίας ως κύριο χρώμα
pane-zen-side-panels-title = Πλευρικοί Πίνακες Ιστού
zen-side-panels-header = Γενικές ρυθμίσεις για πίνακες ιστού
zen-side-panels-description = Αυξήστε την παραγωγικότητα έχοντας πολλαπλές προβολές ταυτόχρονα!
zen-side-panels-enabled = 
    .label = Ενεργοποίηση Πλευρικών Πινάκων Ιστού
zen-side-panels-close-on-blur = 
    .label = Κλείστε τον πίνακα όταν χάνεται η εστίαση, αν δεν είναι καρφιτσωμένος
...
zen-look-and-feel-compact-view-description = Εμφάνιση μόνο των γραμμών εργαλειών που χρησιμοποιείτε!
...
zen-look-and-feel-compact-toolbar-flash-popup = 
    .label = Κάντε το παράθυρο της γραμμής εργαλείων να αναδύεται στιγμιαία κατά την εναλλαγή ή το άνοιγμα νέων καρτελών σε συμπαγή λειτουργία
...
zen-look-and-feel-compact-toolbar-themed = 
    .label = Χρήση θεματικού παρασκηνίου για τη συμπαγή γραμμή εργαλειών
zen-look-and-feel-compact-sidebar-themed = 
    .label = Χρήση θεματικού παρασκηνίου για τη πλευρική μπάρα
...
zen-key-unsafed = Μη αποθηκευμένη συντόμευση! Παρακαλώ αποθηκεύεστε την κάνοντας κλικ στο πλήκτρο "Escape" αφού την πληκτρολογήσετε.
...
zen-vertical-tabs-newtab-on-tab-list = 
    .label = Εμφάνιση κουμπιού Νέας καρτέλας στη λίστα καρτελών
...
zen-vertical-tabs-newtab-top-button-up = 
    .label = Μετακίνηση του κουμπιού νέας καρτέλας επάνω
...
zen-vertical-tabs-expand-tabs-on-hover = Ανάπτυξη καρτελών κατά την αιώρηση (Δεν λειτουργεί σε συμπαγή λειτουργία)
...
zen-theme-marketplace-remove-confirmation = Σίγουρα θέλετε να καταργήσετε αυτή την τροποποίηση;
...
zen-compact-mode-styles-both = Απόκρυψη και των δύο
...
zenCKSOption-group-mediaAndDisplay = Προβολή & Μέσα
...
zen-history-sidebar-shortcut = Εμφάνιση Ιστορικού Πλευρικής Μπάρας
...
zen-compact-mode-shortcut-show-sidebar = Εναλλαγή Πλευρικής Γραμμής
...
zen-workspace-shortcut-forward = Επόμενος Χώρος Εργασίας
zen-workspace-shortcut-backward = Προηγούμενος Χώρος Εργασίας
zen-web-panel-shortcut-toggle = Εναλλαγή Πίνακα Ιστού
zen-sidebar-shortcut-toggle = Εναλλαγή Πλάτους Πλευρικής Γραμμής
...
zen-split-view-shortcut-vertical = Εναλλαγή Κατακόρυφης Διαιρεμένης Προβολής
