...
zen-look-and-feel-themed-toolbar = 
    .label = Κάντε τη γραμμή εργαλείων με θέμα το χρώμα έμφασης
...
zen-key-unsafed = Μη αποθηκευμένη συντόμευση! Παρακαλώ ασφαλίστε την κάνοντας κλικ στο πλήκτρο "Escape" αφού την πληκτρολογήσετε.
...
zen-vertical-tabs-newtab-under-last-tab = 
    .label = Εμφάνιση κουμπιού νέας καρτέλας κάτω από την τελευταία καρτέλα
