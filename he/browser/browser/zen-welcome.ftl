...
zen-welcome-initial-essentials-title = הלשוניות החשובות לך ביותר, תמיד בקרבתך
zen-welcome-initial-essentials-description-1 = הלשוניות הכי חשובות עליך תמיד זמינות בקלות, לא משנה כמה לשוניות פתוחות.
zen-welcome-initial-essentials-description-2 = לשוניות נחוצות תמיד מוצגות, לא משנה באיזה סביבת עבודה.
