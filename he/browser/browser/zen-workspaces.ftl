...
zen-workspaces-delete-workspace-title = מחק סיבת עבודה?
zen-workspaces-delete-workspace-body = האם ברצונך למחוק את סביבת העובדה הזאת הזה? פעולה זו לא ניתנת לביטול.
