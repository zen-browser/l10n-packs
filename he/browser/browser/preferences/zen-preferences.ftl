...
zen-vertical-tabs-show-bottom-border = 
    .label = הצגת מתאר בשביל סמלים תחתונים
...
zen-look-and-feel-buttons-header = סגנון כפתור
zen-look-and-feel-buttons-description = בחירה של עיצוב הכפתורים המעודף עליך
...
zen-settings-workspaces-allow-pinned-tabs-for-different-workspaces = 
    .label = אפשר לסביבות עבודה לאחסן כרטיסיות מוצמדות משלהן
...
zen-vertical-tabs-newtab-top-button-border = 
    .label = הצגת קו מפריד כאשר כפתור כרטיסייה חדשה בתחתית
...
zen-settings-workspaces-display-as-icon-strip = 
    .label = הצג סביבות עבודה כשורת סמלים
...
zen-split-view-change-on-hover = 
    .label = החלפת כרטיסייה על ריחוף עכבר
...
zen-location-open-shortcut-alt = פתח מיקום (Alt)
...
zen-picture-in-picture-toggle-shortcut-alt = הפעל/כבה תמונה-בתמונה (Alt)
zen-picture-in-picture-toggle-shortcut-mac = הפעל/כבה תמונה-בתמונה (Mac)
zen-picture-in-picture-toggle-shortcut-mac-alt = הפעל/כבה תמונה-בתמונה (Mac Alt)
...
zen-search-focus-shortcut-alt = העברת פוקוס לשדה החיפוש (Alt)
...
zen-nav-back-shortcut-alt = ניווט אחורה (Alt)
zen-nav-fwd-shortcut-alt = ניווט קדימה (Alt)
...
zen-search-find-again-shortcut-2 = מצא שוב (Alt)
