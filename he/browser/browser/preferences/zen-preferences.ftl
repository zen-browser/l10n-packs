...
pane-zen-side-panels-title = פאנל אתרים בצד
zen-side-panels-header = הגדרות כלליות לפאנל אתרים
zen-side-panels-description = עליה בפרודוקטיביות מכמה תצוגות באותו זמן!
zen-side-panels-enabled = 
    .label = הפעל פאנל אתרים בצד
zen-side-panels-close-on-blur = 
    .label = סגור את הפאנל שהוא מאבד מיקוד ולא מוצמד
...
pane-zen-tabs-unloader-title = פינוי לשוניות
zen-tabs-unloader-header = הגדרות כלליות למפנה לשוניות
zen-tabs-unloader-description = פינוי אוטומטי של לשוניות לא בשימוש לחסיכת זיכרון
zen-tabs-unloader-enabled = 
    .label = הפעלת פינוי לשוניות
zen-tabs-unloader-unload-delay = 
    .label = פינוי לשוניות לאחר
zen-tabs-unloader-unload-delay-description = הזמן בדקות שאחריו ייפנו לשוניות
...
zen-pinned-tab-manager-description = ניהול התנהגות נוספות של לשוניות מוצמדות
zen-pinned-tab-manager-restore-pinned-tabs-to-pinned-url = 
    .label = שחזור לשוניות מוצמדות לקישור האתר המוצמד המקורי שלהן בהפעלה
zen-pinned-tab-manager-container-specific-essentials-enabled = 
    .label = הפעלת נחוצים משויכים למכלים
zen-pinned-tab-manager-close-shortcut-behavior-label = התנהגות קיצור המקלדת סגור לשונית
zen-pinned-tab-manager-reset-unload-switch-close-shortcut-option = 
    .label = אפס קישור, פנה, ועבור ללשונית הבאה
zen-pinned-tab-manager-unload-switch-close-shortcut-option = 
    .label = פנה ועבור ללשונית הבאה
zen-pinned-tab-manager-reset-switch-close-shortcut-option = 
    .label = אפס קישור ועבור ללשונית הבאה
zen-pinned-tab-manager-switch-close-shortcut-option = 
    .label = עבור ללשונית הבאה
...
zen-settings-workspaces-allow-pinned-tabs-for-different-workspaces = 
    .label = אפשר לסביבות עבודה לאחסן לשוניות מוצמדות משלהן
...
zen-vertical-tabs-title = סדר של סרגל צד ולשוניות
zen-vertical-tabs-header = לשוניות אנכיות
zen-vertical-tabs-description = נהל את הלשוניות שלך בסדר אנכי
zen-vertical-tabs-show-expand-button = 
    .label = הצגת כפתור הרחבה
zen-vertical-tabs-newtab-on-tab-list = 
    .label = הצגת כפתור לשונית חדשה ברשימת לשוניות
zen-vertical-tabs-newtab-top-button-border = 
    .label = הצגת קו מפריד כאשר כפתור לשונית חדשה בתחתית
zen-vertical-tabs-newtab-top-button-up = 
    .label = הזזה של כפתור לשונית חדשה לאיזור העליון
...
zen-vertical-tabs-expand-tabs-on-hover = הרחב לשוניות על ריחוף עכבר (לא יעבוד במצב מכווץ)
zen-vertical-tabs-expand-tabs-header = איך להרחיב לשוניות
zen-vertical-tabs-expand-tabs-description = איך לשוניות מורחבות בסרגל צד
...
zen-theme-marketplace-updates-fail = לא נמצאו עדכונים!
...
zen-settings-workspaces-display-as-icon-strip = 
    .label = הצגת סביבות עבודה כשורת סמלים
zen-settings-workspaces-force-container-tabs-to-workspace = 
    .label = העברה לסביבת עבודה שבה המכל מוגדר כברירת מחדל שפותחים לשונית במכל
zen-settings-workspaces-hide-deactivated-workspaces = 
    .label = הסתרה של סביבות עבודה מושבתות
...
zen-split-view-title = תצוגה מפוצלת
zen-split-view-header = פונקציונליות של תצוגה מפוצלת
zen-split-view-description = מאפשר לך לפצל את הדפדפן למספר תצוגות, כך שניתן לך לגלוש במספר אתרים בו זמנית
zen-split-view-change-on-hover = 
    .label = החלפת לשונית על ריחוף עכבר
zen-compact-mode-styles-left = הסתרת סרגל לשוניות
...
zen-restore-last-closed-tab-shortcut = שחזר לשונית אחרונה שנסגרה
...
zen-search-focus-shortcut = העבר פוקוס לשדה החיפוש
zen-search-focus-shortcut-alt = העבר פוקוס לשדה החיפוש (משני)
...
zen-close-shortcut-2 = סגור לשונית
...
zen-close-tab-shortcut = סגור לשונית
...
zen-web-panel-shortcut-toggle = הפעל/כבה פאנל אתר
zen-sidebar-shortcut-toggle = הפעל/כבה עובי של סרגל צד
zen-pinned-tab-shortcut-reset = אפס לשונית מוצמדת לקישור מוצמד
...
zen-key-select-tab-1 = בחר לשונית #1
zen-key-select-tab-2 = בחר לשונית #2
zen-key-select-tab-3 = בחר לשונית #3
zen-key-select-tab-4 = בחר לשונית #4
zen-key-select-tab-5 = בחר לשונית #5
zen-key-select-tab-6 = בחר לשונית #6
zen-key-select-tab-7 = בחר לשונית #7
zen-key-select-tab-8 = בחר לשונית #8
zen-key-select-tab-last = בחר לשונית אחרונה
zen-key-show-all-tabs = הצג את כל הלשוניות
