...
zen-tabs-unloader-unload-delay = 
    .label = Sonra sekmeleri uyku moduna al
...
zen-key-unsafed = Kaydedilmemiş kısayol! Lütfen tekrar yazdıktan sonra "Escape" tuşuna basarak kaydedin.
...
zen-split-view-title = Bölünmüş Görünüm
zen-split-view-header = Bölünmüş Görünüm İşlevselliği
zen-split-view-description = Tarayıcınızı birden fazla görünüme bölerek aynı anda birden fazla web sitesine göz atmanızı sağlar
zen-split-view-change-on-hover = 
    .label = Üzerine gelindiğinde sekmeleri değiştir
