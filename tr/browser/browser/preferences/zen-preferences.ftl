...
zen-look-and-feel-use-workspace-colors = 
    .label = Çalışma alanı renklerini birincil renk olarak kullan
...
zen-look-and-feel-buttons-header = Düğme tarzı
...
zen-vertical-tabs-newtab-top-button-border = 
    .label = Yeni Sekme butonu altta olduğunda ayırıcı çizgi göster
...
zen-settings-workspaces-hide-deactivated-workspaces = 
    .label = Aktif olmayan çalışma alanlarını gizle
...
zen-key-inspector-mac = İnceleyi Aç/Kapat (Mac)
zen-toggle-sidebar-shortcut = Firefox Kenarçubuğunu Aç/Kapat
