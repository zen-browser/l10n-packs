...
welcome-dialog-search-subtext = İnternette gezinme deneyimini kişiselleştirmek için tercih ettiğin arama motorunu seç!
welcome-dialog-thanks = Çok Teşekkürler! ❤️
welcome-dialog-thanks-subtext = Takdirin bizim için dünyalar kadar değerli!
welcome-dialog-back-action = Geri
