...
zen-vertical-tabs-show-bottom-border = 
    .label = Rodyti apatinių piktogramų kraštinę
sync-currently-syncing-workspaces = Darbo sritys
sync-engine-workspaces = 
    .label = Darbo sritys
    .tooltiptext = Sinchronizuokite savo darbo sritis tarp įrenginių
    .accesskey = W
zen-glance-title = Greitai pažiūrėti
zen-glance-header = Bendrieji greito pažūrėjimo nustatymai
...
zen-pinned-tab-manager-reset-unload-switch-close-shortcut-option = 
    .label = Iš naujo nustatyti URL, iškelti ir perjungti į kitą kortelę
...
zen-vertical-tabs-newtab-under-last-tab = 
    .label = Rodyti naujos kortelės mygtuką po paskutine kortele
...
zen-theme-disable-all-enabled = 
    .title = Išjungti visas temas
zen-theme-disable-all-disabled = 
    .title = Įjungti visas temas
...
zen-settings-workspaces-hide-deactivated-workspaces = 
    .label = Slėpti deaktyvuotas darbo sritis
