...
zen-settings-workspaces-enabled = 
    .label = Habilitar áreas de trabajo
...
zen-settings-workspaces-allow-pinned-tabs-for-different-workspaces = 
    .label = Permitir que las áreas de trabajo tengan sus propias pestañas ancladas
...
zen-vertical-tabs-expand-tabs-description = Escoge cómo expandir las pestañas en la barra lateral
zen-theme-marketplace-header = Zen Mods
zen-theme-disable-all-enabled = 
    .title = Deshabilitar todos los mods
zen-theme-disable-all-disabled = 
    .title = Habilitar todos los mods
zen-theme-marketplace-description = Busca e instala mods de la tienda.
...
zen-settings-workspaces-display-as-icon-strip = 
    .label = Mostrar las áreas de trabajo como una franja de iconos
zen-settings-workspaces-force-container-tabs-to-workspace = 
    .label = Cambiar al área de trabajo donde el contenedor esté establecido por defecto al abrir las pestañas contenedoras
...
zen-split-view-description = Divide tu navegador en múltiples vistas, permitiéndote navegar por varios sitios web a la vez
