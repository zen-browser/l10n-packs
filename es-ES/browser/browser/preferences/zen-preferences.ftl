...
zen-pinned-tab-manager-description = Administre el comportamiento adicional de las pestañas ancladas
...
zen-theme-marketplace-description = Busque e instale mods de la tienda.
...
zen-split-view-description = Divida su navegador en múltiples vistas, permitiéndole navegar por varios sitios web a la vez
