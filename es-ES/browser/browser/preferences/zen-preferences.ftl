...
sync-currently-syncing-workspaces = Áreas de trabajo
sync-engine-workspaces = 
    .label = Áreas de trabajo
    .tooltiptext = Sincroniza tus áreas de trabajo en todos tus dispositivos
    .accesskey = M
zen-glance-title = Glance
zen-glance-header = Configuración general de Glance
zen-glance-description = Echa un vistazo rápido a tus enlaces sin abrirlos en una nueva pestaña
...
zen-pinned-tab-manager-header = Ajustes generales de las pestañas ancladas
zen-pinned-tab-manager-description = Administrar el comportamiento adicional de las pestañas ancladas
zen-pinned-tab-manager-restore-pinned-tabs-to-pinned-url = 
    .label = Restaurar pestañas ancladas a su URL inicial al inicio del navegador
zen-pinned-tab-manager-container-specific-essentials-enabled = 
    .label = Activar esenciales específicos del contenedor
...
zen-settings-workspaces-header = Ajustes generales de las áreas de trabajo
