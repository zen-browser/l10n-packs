...
zen-vertical-tabs-layout-description = Elige el diseño que más te convenga
...
zen-look-and-feel-buttons-description = Elige el estilo de botones que deseas ver
...
zen-vertical-tabs-expand-tabs-description = Elige cómo expandir las pestañas en la barra lateral
...
zen-split-view-change-on-hover = 
    .label = Cambiar de pestaña al pasar el cursor
