...
zen-look-and-feel-colors-description = Haz que la apariencia de { -brand-short-name } esté a tu gusto
...
zen-side-panels-description = ¡Aumenta la productividad teniendo múltiples vistas a la vez!
...
zen-look-and-feel-compact-view-description = ¡Muestra solo las barras de herramientas que usas!
...
zen-pinned-tab-manager-description = Controla el comportamiento adicional de las pestañas ancladas
...
zen-pinned-tab-manager-container-specific-essentials-enabled = 
    .label = Habilitar esenciales de contenedor específico
...
zen-vertical-tabs-description = Administra tus pestañas en disposición vertical
...
zen-theme-marketplace-description = Busca e instala mods del almacén.
