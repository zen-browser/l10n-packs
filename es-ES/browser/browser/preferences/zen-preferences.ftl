...
sync-engine-workspaces = 
    ...
    .tooltiptext = Sincroniza tus espacios de trabajo en todos tus dispositivos
    .accesskey = M
...
zen-settings-workspaces-description = Con los espacios de trabajo, ¡puedes tener múltiples sesiones de navegación a la vez!
...
zen-settings-workspaces-allow-pinned-tabs-for-different-workspaces = 
    .label = Permitir que los espacios de trabajo tengan sus propias pestañas ancladas
...
zen-settings-CKS-reset-shortcuts = 
    .label = Restablecer valor por defecto
