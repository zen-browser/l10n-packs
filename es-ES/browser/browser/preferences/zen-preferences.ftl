...
zen-look-and-feel-pilled-buttons = 
    .label = Botones con forma de píldora
...
zen-pinned-tab-manager-restore-pinned-tabs-to-pinned-url = 
    .label = Restaurar pestañas ancladas a su URL fijada inicial al inicio del navegador
...
zen-sidebar-shortcut-toggle = Alternar ancho de la barra lateral
