...
zen-workspaces-panel-context-open-in-container-tab = 
    ...
    .accesskey = O
zen-workspaces-how-to-reorder = Para reordenar los espacios, arrástrelos y suéltelos desde los iconos de espacios en la parte inferior de la barra lateral.
