zen-panel-ui-workspaces-text = Espacios
...
zen-workspaces-delete-workspace-title = ¿Eliminar espacio?
zen-workspaces-delete-workspace-body = ¿Seguro que quiere eliminar este espacio? Esta acción no se puede deshacer.
