...
pane-zen-side-panels-title = Painéil Ghréasáin Taobh
zen-side-panels-header = Socruithe ginearálta do phainéil ghréasáin
...
zen-side-panels-close-on-blur = 
    .label = Dún an painéal nuair a chailleann é fhócas mura bhfuil é rinne
...
zen-look-and-feel-buttons-header = Stíl na gcnaipí
zen-look-and-feel-buttons-description = Roghnaigh stíl na gcnaipí is mian leat a fheiceáil
zen-look-and-feel-pilled-buttons = 
    .label = Bainistíocht Táb
