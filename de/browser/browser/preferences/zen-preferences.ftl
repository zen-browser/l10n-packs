...
zen-side-panels-enabled = 
    .label = Seitliche Web-Panels aktivieren
...
zen-glance-trigger-mantain-click = 
    .label = Klicke verwalten (Kommt bald!)
...
pane-zen-tabs-unloader-title = Tab Speicherfreigabe
...
zen-pinned-tab-manager-container-specific-essentials-enabled = 
    .label = Container-spezifische Grundlagen aktivieren
...
zen-settings-workspaces-description = Mit Workspaces, können Sie mehrere Browser Sitzungen auf einmal durchführen!
...
zen-vertical-tabs-newtab-top-button-border = 
    .label = Trennlinie anzeigen, wenn die Schaltfläche „Neuer Tab“ unten ist
...
zen-dark-theme-styles-default = Standard dunkles Thema
zen-dark-theme-styles-colorful = Farbenfrohes dunkles Thema
zen-split-view-title = Ansicht teilen
zen-split-view-header = Aufteilungsfunktion
zen-split-view-description = Teile deinen Browser in mehrere Ansichten, damit  du mehrere Webseiten gleichzeitig durchsuchen kannst
zen-split-view-change-on-hover = 
    .label = Tabs beim Darüberfahren ändern
...
zen-urlbar-description = Passe die URL Bar nach Belieben an
zen-urlbar-behavior-label = Verhalten
zen-urlbar-behavior-normal = 
    .label = Normal
zen-urlbar-behavior-floating-on-type = 
    .label = Nur beim Tippen einblenden
zen-urlbar-behavior-float = 
    .label = Immer einblenden
...
zen-devtools-toggle-inspector-shortcut = Inspektor
