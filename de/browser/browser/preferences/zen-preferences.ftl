...
zen-look-and-feel-compact-toolbar-flash-popup = 
    .label = Erstellen Sie kurz das Popup in der Symbolleiste beim Wechseln oder Öffnen neuer Tabs im kompakten Modus
...
zen-vertical-tabs-newtab-under-last-tab = 
    .label = Neuen Tab unter dem letzten Tab anzeigen
