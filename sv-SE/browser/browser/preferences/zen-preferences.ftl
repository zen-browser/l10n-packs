...
zen-warning-language = Ändra standardspråk kan göra det lättare för webbplatser att spåra dig.
zen-look-and-feel-colors-header = Välj en temafärg
zen-look-and-feel-colors-description = Få { -brand-short-name } att se ut och känna som du vill
zen-look-and-feel-themed-toolbar = 
    .label = Gör verktygsfältet tema med accentfärg
pane-zen-side-panels-title = Webbpaneler för sida
...
zen-side-panels-enabled = 
    .label = Aktivera sidopaneler
zen-side-panels-close-on-blur = 
    .label = Stäng panelen när den förlorar fokus om den inte är fäst
zen-vertical-tabs-show-bottom-border = 
    .label = Visa kant för de nedre ikonerna
...
zen-look-and-feel-buttons-header = Stil på knapp
zen-look-and-feel-buttons-description = Välj stil på knapparna du vill se
zen-look-and-feel-pilled-buttons = 
    .label = Pillerade knappar
...
zen-settings-workspaces-allow-pinned-tabs-for-different-workspaces = 
    .label = Tillåt arbetsytor har egna fästa flikar
zen-key-unsafed = Osparad genväg! Vänligen säkra den genom att klicka på "Escape" knappen efter att du skrivit om den.
...
zen-vertical-tabs-newtab-under-last-tab = 
    .label = Visa ny flik-knapp under den senaste fliken
...
zen-theme-marketplace-updates-fail = Kunde inte hitta några uppdateringar!
...
zen-settings-workspaces-display-as-icon-strip = 
    .label = Visa arbetsytor som en ikonremsa
...
zen-settings-workspaces-hide-deactivated-workspaces = 
    .label = Dölj inaktiverade arbetsytor
...
zen-split-view-description = Dela upp din webbläsare i flera vyer så att du kan bläddra på flera webbplatser samtidigt
zen-split-view-change-on-hover = 
    .label = Ändra flikar vid hovring
zen-compact-mode-styles-left = Dölj flikfält
