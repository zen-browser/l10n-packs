...
zen-look-and-feel-use-workspace-colors = 
    .label = Використовуйте кольори робочого простору як основний колір
pane-zen-side-panels-title = Сторонні вебпанелі
zen-side-panels-header = Загальні налаштування для вебпанелей
