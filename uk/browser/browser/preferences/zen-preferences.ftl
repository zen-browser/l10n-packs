...
zen-look-and-feel-colors-header = Вибрати колір теми
zen-look-and-feel-colors-description = Зробіть { -brand-short-name } схожим на себе
zen-look-and-feel-themed-toolbar = 
    .label = Зробити панель інструментів темою з кольором акценту
pane-zen-side-panels-title = Сторонні веб-панелі
zen-side-panels-header = Загальні налаштування для веб-панелей
zen-side-panels-description = Підвищуйте продуктивність, отримуючи кілька поглядів одночасно!
zen-side-panels-enabled = 
    .label = Увімкнути веб-бічні панелі
zen-side-panels-close-on-blur = 
    .label = Закриває панель коли вона втрачає фокус, якщо вона не прикріплюється
zen-vertical-tabs-show-bottom-border = 
    .label = Показувати рамку для нижніх значків
...
zen-look-and-feel-compact-toolbar-flash-popup = 
    .label = Коротко зробіть спливаюче вікно на панелі інструментів при перемиканні або відкритті нових вкладок у режимі компактного режиму
zen-look-and-feel-buttons-header = Стиль кнопок
zen-look-and-feel-buttons-description = Виберіть стиль кнопок
zen-look-and-feel-pilled-buttons = 
    .label = Загублені кнопки
...
zen-pinned-tab-manager-header = Загальні налаштування закріплених вкладок
zen-pinned-tab-manager-description = Керування додатковою поведінкою закріплених вкладок
zen-pinned-tab-manager-restore-pinned-tabs-to-pinned-url = 
    .label = Відновити закріплені вкладки при запуску
...
zen-settings-workspaces-allow-pinned-tabs-for-different-workspaces = 
    .label = Дозволити робочі простори мають свої закріплені вкладки
zen-key-unsafed = Незбережений ярлик! Захистіть його, натиснувши на кнопку „Escape“ після його введення.
...
zen-vertical-tabs-newtab-under-last-tab = 
    .label = Відображати кнопку нової вкладки під останньою вкладкою
...
zen-theme-marketplace-updates-fail = Не вдалося знайти оновлення!
...
zen-settings-workspaces-display-as-icon-strip = 
    .label = Показати робочі області в якості виокремлення
...
zen-settings-workspaces-hide-deactivated-workspaces = 
    .label = Приховати неактивовані робочі області
...
zen-split-view-title = Розділений вигляд
zen-split-view-header = Розділити функції перегляду
zen-split-view-description = Розділіть свій браузер на кілька переглядів, що дозволяє одночасно переглядати кілька сайтів
zen-split-view-change-on-hover = 
    .label = Зміна вкладок при наведенні курсору
...
zen-compact-mode-shortcut-show-sidebar = Перемкнути Спливаючу бічну панель
zen-compact-mode-shortcut-show-toolbar = Перемкнути Спливаючу панель
...
zen-web-panel-shortcut-toggle = Переключити веб-панель
zen-sidebar-shortcut-toggle = Перемкнути ширину бічної панелі
zen-pinned-tab-shortcut-reset = Скинути закріплену вкладку по Закріпленому URL
