zen-panel-ui-workspaces-text = Робочі простори
...
zen-workspaces-panel-context-open = 
    .label = Відкрити робочий простір
    .accesskey = O
zen-workspaces-panel-context-set-default = 
    .label = Встановити як типовий робочий простір
    .accesskey = S
...
zen-workspaces-delete-workspace-title = Видалити робочий простір?
zen-workspaces-delete-workspace-body = Упевнені, що хочете видалити свій робочий простір? Цю дію не можна скасувати.
