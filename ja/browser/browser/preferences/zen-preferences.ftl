...
zen-pinned-tab-manager-restore-pinned-tabs-to-pinned-url = 
    .label = ピン留めされてタブを起動時にもとのURLに復元する
zen-pinned-tab-manager-close-shortcut-behavior-label = タブを閉じるときのショートカットの操作
zen-pinned-tab-manager-reset-unload-switch-close-shortcut-option = 
    .label = URLをリセット、アンロードし次のタブに切り替える
...
zen-key-unsafed = 未保存のショートカットです！再入力後 "Escape" キーを入力してください。
zen-key-conflict = 他のショートカットと競合しています
...
zen-page-info-shortcut = ページ情報を見る
zen-find-shortcut = ページ内を検索
zen-search-find-again-shortcut = もう一度検索
