...
zen-workspace-continue-where-left-off = 
    .label = Continue onde você parou
...
zen-theme-marketplace-updates-failure = Não foi possível encontrar atualizações!
...
zen-key-select-tab-1 = Selecione a aba #1
zen-key-select-tab-2 = Selecione a aba #2
zen-key-select-tab-3 = Selecione a aba #3
zen-key-select-tab-4 = Selecione a aba #4
zen-key-select-tab-5 = Selecione a aba #5
zen-key-select-tab-6 = Selecione a aba #6
zen-key-select-tab-7 = Selecione a aba #7
zen-key-select-tab-8 = Selecione a aba #8
