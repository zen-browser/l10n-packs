...
zen-web-side-panel-context-unmute-panel = 
    .label = Uitschakelen van webpaneel
    .accesskey = min
...
zen-web-side-panel-context-add-to-panel = 
    ...
    .accesskey = A
zen-sidebar-introduction-title = Welkom bij Zen Sidebar
zen-sidebar-introduction-description = Zen Sidebar is een nieuwe manier om te bladeren op het web. Klik op een van de iconen om een webpaneel te openen.
