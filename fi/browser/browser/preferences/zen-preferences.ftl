...
zen-key-unsafed = Tallentamaton pikakuvake! Ole hyvä ja turvaa se painamalla "Escape" -näppäintä kirjoittamisen jälkeen.
...
zen-vertical-tabs-newtab-top-button-border = 
    .label = Näyä erotusraja, kun uusi välilehti painike on alareunassa
...
zen-split-view-header = Jaetun näkymän -toiminnallisuus
...
zen-split-view-change-on-hover = 
    .label = Vaihda välilehtiä leijailemalla hiirellä
