...
zen-vertical-tabs-show-bottom-border = 
    .label = Показать границу для нижних иконок
sync-currently-syncing-workspaces = Рабочие пространства
sync-engine-workspaces = 
    .label = Рабочие пространства
    .tooltiptext = Синхронизируйте свои рабочие пространства на разных устройствах
    .accesskey = W
...
zen-pinned-tab-manager-restore-pinned-tabs-to-pinned-url = 
    .label = Восстановить закрепленные вкладки до их исходного URL при запуске
zen-pinned-tab-manager-close-shortcut-behavior-label = Поведение сочетания клавиш для закрытия вкладки
...
zen-settings-workspaces-force-container-tabs-to-workspace = 
    .label = Переключиться на рабочую область, в которой контейнер установлен по умолчанию при открытии вкладок контейнера
zen-settings-workspaces-hide-deactivated-workspaces = 
    .label = Скрыть отключенные рабочие области
...
zen-pinned-tab-shortcut-reset = Сбросить закрепленную вкладку до закрепленного URL
