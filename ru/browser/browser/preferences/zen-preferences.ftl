...
zen-theme-marketplace-export-success = Дополнения успешно импортированы
zen-theme-marketplace-export-failure = Во время экспортирования дополнений произошла ошибка
...
zen-compact-mode-shortcut-show-sidebar = Вкл./выкл. плавающую боковую панель
...
zen-devtools-toggle-accessibility-shortcut = Вкл./выкл. специальные возможности
