...
zen-look-and-feel-use-workspace-colors = 
    .label = Использовать цвета рабочего пространства как основной цвет
...
sync-engine-workspaces = 
    ...
    .tooltiptext = Синхронизация рабочих пространств между устройствами
    .accesskey = В
...
zen-settings-workspaces-description = С рабочими пространствами вы можете использовать несколько сеансов просмотра одновременно!
...
zen-settings-workspaces-allow-pinned-tabs-for-different-workspaces = 
    .label = Разрешить рабочему пространству иметь собственные закрепленные вкладки
...
zen-settings-workspaces-display-as-icon-strip = 
    .label = Показать рабочие пространства как полоску иконок
zen-settings-workspaces-force-container-tabs-to-workspace = 
    .label = Переключиться в рабочее пространство, где контейнер установлен по умолчанию, при открытии вкладок контейнера
zen-settings-workspaces-hide-deactivated-workspaces = 
    .label = Скрыть деактивированные рабочие пространства
...
zen-workspace-shortcut-switch-1 = Переключиться на рабочее пространство 1
zen-workspace-shortcut-switch-2 = Переключиться на рабочее пространство 2
zen-workspace-shortcut-switch-3 = Переключиться на рабочее пространство 3
zen-workspace-shortcut-switch-4 = Переключиться на рабочее пространство 4
zen-workspace-shortcut-switch-5 = Переключиться на рабочее пространство 5
zen-workspace-shortcut-switch-6 = Переключиться на рабочее пространство 6
zen-workspace-shortcut-switch-7 = Переключиться на рабочее пространство 7
zen-workspace-shortcut-switch-8 = Переключиться на рабочее пространство 8
zen-workspace-shortcut-switch-9 = Переключиться на рабочее пространство 9
zen-workspace-shortcut-switch-10 = Переключиться на рабочее пространство 0
zen-workspace-shortcut-forward = Следующее рабочее пространство
zen-workspace-shortcut-backward = Предыдущее рабочее пространство
