...
zen-warning-language = Изменение языка может облегчить отслеживание вас сайтами.
...
zen-vertical-tabs-layout-description = Выберите макет, который понравится вам больше всего
zen-layout-single-toolbar = Одна панель инструментов
zen-layout-multiple-toolbar = Несколько панелей инструментов
zen-layout-collapsed-toolbar = Свёрнутая панель инструментов
...
sync-engine-workspaces = 
    ...
    .accesskey = W
zen-glance-title = Обзор
zen-glance-header = Общие настройки обзора
zen-glance-description = Быстро просматривайте ссылки, не открывая их в новой вкладке
zen-glance-trigger-label = Способ активации
zen-glance-enabled = 
    .label = Включить функцию обзора
...
zen-glance-trigger-mantain-click = 
    .label = Держите зажатой ЛКМ (скоро!)
...
pane-zen-tabs-unloader-title = Выгрузчик вкладок
...
zen-look-and-feel-compact-toolbar-themed = 
    .label = Использовать тематический фон для компактной панели инструментов
zen-look-and-feel-compact-sidebar-themed = 
    .label = Использовать тематический фон для компактной боковой панели
pane-zen-pinned-tab-manager-title = Закреплённые вкладки
zen-pinned-tab-manager-header = Общие настройки закреплённых вкладок
zen-pinned-tab-manager-description = Задайте дополнительные настройки поведению закреплённых вкладок
zen-pinned-tab-manager-restore-pinned-tabs-to-pinned-url = 
    .label = Восстанавливать закреплённые вкладки к их исходной ссылке при запуске
zen-pinned-tab-manager-container-specific-essentials-enabled = 
    .label = Включить специфические для контейнеров важные страницы
zen-pinned-tab-manager-close-shortcut-behavior-label = Действие при закрытии вкладки
...
zen-key-unsafed = Несохранённая комбинация! Сохраните её, нажав клавишу Escape после ввода.
zen-key-conflict = Конфликт с другой комбинацией
pane-zen-theme-title = Настройки темы
zen-vertical-tabs-title = Макет боковой панели и вкладок
...
zen-vertical-tabs-newtab-on-tab-list = 
    .label = Показать кнопку создания новой вкладки в списке вкладок
zen-vertical-tabs-newtab-top-button-border = 
    .label = Показывать разделительную линию, если кнопка создания новой кнопки снизу
zen-vertical-tabs-newtab-top-button-up = 
    .label = Переместить кнопку создания новой вкладки наверх
...
zen-theme-marketplace-description = Найдите и установите моды из магазина.
...
zen-settings-workspaces-display-as-icon-strip = 
    .label = Отображать рабочие пространства в ряду из значков
...
zen-split-view-shortcut-unsplit = Закрыть сплит вид
