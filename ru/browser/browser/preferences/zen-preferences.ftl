...
zen-theme-marketplace-header = Дополнения Zen
zen-theme-disable-all-enabled = 
    .title = Отключить все дополнения
zen-theme-disable-all-disabled = 
    .title = Включить все дополнения
zen-theme-marketplace-description = Находите и устанавливайте дополнения из магазина.
zen-theme-marketplace-remove-button = 
    .label = Удалить мод
zen-theme-marketplace-check-for-updates-button = 
    .label = Проверить наличие обновлений
zen-theme-marketplace-updates-success = Дополнения успешно обновлены
