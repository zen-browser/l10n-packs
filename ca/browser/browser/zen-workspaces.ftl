zen-panel-ui-workspaces-text = Espais
zen-panel-ui-workspaces-create = 
    .label = Crea un espai
zen-workspaces-panel-context-delete = 
    .label = Elimina l'espai
    .accesskey = D
...
zen-workspaces-delete-workspace-title = Voleu eliminar l'espai?
zen-workspaces-delete-workspace-body = Esteu segur que voleu eliminar aquest espai? Aquesta acció no es pot desfer.
