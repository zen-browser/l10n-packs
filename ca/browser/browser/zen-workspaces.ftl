...
zen-workspaces-panel-context-open-in-container-tab = 
    ...
    .accesskey = O
zen-workspaces-how-to-reorder = Per reordenar els espais, arrossegueu-los i deixeu-los anar des de les icones d'espais a la part inferior de la barra lateral.
