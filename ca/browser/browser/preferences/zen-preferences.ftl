...
zen-key-stop = Deixar de carregar
...
zen-close-shortcut = Tancar la finestra
zen-close-tab-shortcut = Tancar la pestanya
...
zen-split-view-shortcut-unsplit = Tancar la vista dividida
zen-key-select-tab-1 = Mostrar finestra #1
zen-key-select-tab-2 = Mostrar finestra #2
zen-key-select-tab-3 = Mostrar finestra #3
zen-key-select-tab-4 = Mostrar finestra #4
zen-key-select-tab-5 = Mostrar finestra #5
zen-key-select-tab-6 = Mostrar finestra #6
zen-key-select-tab-7 = Mostrar finestra #7
zen-key-select-tab-8 = Mostrar finestra #8
zen-key-select-tab-last = Ultima finestra
zen-key-show-all-tabs = Mostrar totes les finestres
zen-key-goto-history = Historial
zen-key-go-home = Pagina d'inici
zen-bookmark-show-sidebar-shortcut = Mostrar els Marcadors
zen-bookmark-show-toolbar-shortcut = Mostrar els Marcadors a la barra d'eines
zen-devtools-toggle-shortcut = Alterna Mostrar les eines de desenvolupament
zen-devtools-toggle-browser-toolbox-shortcut = Alterna Mostrar la caixa d'eines del navegador
zen-devtools-toggle-browser-console-shortcut = Alterna Mostrar la Consola del Navegador
zen-devtools-toggle-responsive-design-mode-shortcut = Alterna Mostrar el mode de disseny responsable
zen-devtools-toggle-inspector-shortcut = Alterna Mostrar l'Inspector
zen-devtools-toggle-web-console-shortcut = Alterna Mostrar la Consola Web
zen-devtools-toggle-js-debugger-shortcut = Alterna Mostrar el Depurador de JS
zen-devtools-toggle-net-monitor-shortcut = Alterna Mostrar el Monitor de Xarxa
zen-devtools-toggle-style-editor-shortcut = Alterna Mostrar l'Editor d'estil
zen-devtools-toggle-performance-shortcut = Alterna Mostrar Mostrar el Rendiment
zen-devtools-toggle-storage-shortcut = Alterna Mostrar l'Emmagatzematge
zen-devtools-toggle-dom-shortcut = Alterna Mostrar DOM
zen-devtools-toggle-accessibility-shortcut = Alterna Mostrar Accessibilitat
