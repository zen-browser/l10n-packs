...
zen-key-unsafed = Pintasan belum disimpan! Silakan simpan dengan mengklik tombol "Esc" setelah mengetik ulang.
...
zen-bookmark-show-sidebar-shortcut = Tampilkan Sidebar Bookmark
zen-bookmark-show-toolbar-shortcut = Tampilkan Toolbar Bookmark
