...
zen-vertical-tabs-show-bottom-border = 
    .label = Tampilkan pemisah untuk ikon bawah
...
zen-glance-description = Dapatkan gambaran cepat tentang tautan Anda tanpa membukanya di tab baru
...
zen-look-and-feel-compact-toolbar-flash-popup = 
    .label = Buat bilah tab muncul sesaat saat beralih atau membuka tab baru dalam mode ringkas
...
zen-split-view-change-on-hover = 
    .label = Ubah fokus tab saat melayangkan kursor
