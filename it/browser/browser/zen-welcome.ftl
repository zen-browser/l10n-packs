...
welcome-dialog-welcome = 👋 Benvenuto in { -brand-short-name }
welcome-dialog-welcome-subtext = Veloce. Bello. Privato.
...
welcome-dialog-thanks = Grazie Tantissimo! ❤️
welcome-dialog-thanks-subtext = Il tuo apprezzamento significa per noi il mondo!
welcome-dialog-back-action = Indietro
welcome-dialog-next-action = Successivo
