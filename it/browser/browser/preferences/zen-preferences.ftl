...
zen-look-and-feel-themed-toolbar = 
    .label = Rendi la barra degli strumenti a tema con il colore accento
...
pane-zen-tabs-title = Gestione Tab
...
zen-key-unsafed = Scorciatoia non salvata! Si prega di proteggerla facendo clic sul tasto "Escape" dopo averlo ripetuto.
...
zen-vertical-tabs-newtab-under-last-tab = 
    .label = Mostra il nuovo pulsante della scheda sotto l'ultima scheda
