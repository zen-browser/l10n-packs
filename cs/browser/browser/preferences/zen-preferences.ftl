...
sync-currently-syncing-workspaces = Pracoviště
sync-engine-workspaces = 
    .label = Pracoviště
    .tooltiptext = Synchronizovat vaše pracoviště napříč zařízeními
    .accesskey = W
...
zen-pinned-tab-manager-reset-switch-close-shortcut-option = 
    .label = Resetovat URL adresu a přepnout na další kartu
...
zen-theme-disable-all-enabled = 
    .title = Vypnout všechny motivy
zen-theme-disable-all-disabled = 
    .title = Zapnout všechny motivy
...
zen-settings-workspaces-hide-deactivated-workspaces = 
    .label = Skrýt vypnuté pracoviště
...
zen-key-redo = Redo
zen-restore-last-closed-tab-shortcut = Obnovit posledně zavřenou kartu
...
zen-reader-mode-toggle-shortcut-windows = Přepnout čtenářský režim (Windows)
...
zen-page-source-shortcut-safari = Zobrazit zdrojový kód stránky (Safari)
