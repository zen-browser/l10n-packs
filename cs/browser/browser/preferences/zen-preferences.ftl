...
zen-warning-language = Změna výchozího jazyka usnadní webovým stránkám vaše sledování.
...
zen-glance-header = Obecná nastavení pro náhled
zen-glance-description = Získejte rychlý náhled vašich odkazů, aniž byste je otevřeli v nové kartě
...
zen-pinned-tab-manager-reset-unload-switch-close-shortcut-option = 
    .label = Obnovit URL, uspat a přepnout na další panel
