...
zen-side-panels-close-on-blur = 
    .label = Fechar o painel quando ele perde o foco se não estiver afixado
...
pane-zen-pinned-tab-manager-title = Separadores Afixados
zen-pinned-tab-manager-header = Configurações gerais para separadores afixados
zen-pinned-tab-manager-description = Gerir comportamento adicional de separadores afixados
zen-pinned-tab-manager-restore-pinned-tabs-to-pinned-url = 
    .label = Restaurar os separadores afixados para o seu URL originalmente afixado no arranque
...
zen-settings-workspaces-allow-pinned-tabs-for-different-workspaces = 
    .label = Permitir que espaços de trabalho tenham os seus próprios separadores afixados
...
zen-vertical-tabs-newtab-under-last-tab = 
    .label = Mostrar o botão de novo separador abaixo do último separador
...
zen-settings-workspaces-display-as-icon-strip = 
    .label = Mostrar espaços de trabalho como tira de ícones
...
zen-pinned-tab-shortcut-reset = Repor o Separador Afixado para a URL Afixada
