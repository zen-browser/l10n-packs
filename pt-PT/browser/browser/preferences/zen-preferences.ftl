pane-zen-looks-title = Aspecto e Comportamento
category-zen-looks = 
    .tooltiptext = { pane-zen-looks-title }
zen-warning-language = Alterar o idioma padrão pode tornar mais fácil para os sites rastrearem você.
zen-look-and-feel-colors-header = Escolha uma cor temática
zen-look-and-feel-colors-description = Faça { -brand-short-name } parecer e sentir o jeito que quiser
zen-look-and-feel-themed-toolbar = 
    .label = Torne a barra de ferramentas temática com a cor de destaque
pane-zen-side-panels-title = Painéis Web Laterais
zen-side-panels-header = Configurações gerais para painéis web
zen-side-panels-description = Aumente a produtividade por ter múltiplas visualizações de uma vez!
zen-side-panels-enabled = 
    .label = Ativar painéis laterais Web
zen-side-panels-close-on-blur = 
    .label = Feche o painel quando ele perder foco se ele não estiver fixado
zen-vertical-tabs-show-bottom-border = 
    .label = Mostrar a borda inferior dos ícones
sync-currently-syncing-workspaces = Projetos
sync-engine-workspaces = 
    .label = Projetos
    .tooltiptext = Sincronize seus espaços de trabalho entre dispositivos
    .accesskey = PO
zen-glance-title = Olhar
zen-glance-header = Confira as configurações gerais
zen-glance-description = Obtenha uma visão geral de seus links sem abri-los em uma nova aba
...
zen-look-and-feel-compact-toolbar-flash-popup = 
    .label = Faça um breve pop-up na barra de ferramentas ao alternar ou abrir novas abas no modo compacto
...
zen-look-and-feel-pilled-buttons = 
    .label = Botões Paturados
pane-zen-tabs-title = Gerenciador de Abas
category-zen-workspaces = 
    .tooltiptext = { pane-zen-tabs-title }
pane-settings-workspaces-title = Projetos
pane-zen-tabs-unloader-title = Tab Unloader
zen-tabs-unloader-header = Configurações gerais para o tab unloader
zen-tabs-unloader-description = Descarregar automaticamente abas não utilizadas para economizar memória
zen-tabs-unloader-enabled = 
    .label = Habilitar o Descarregador de Guias
zen-tabs-unloader-unload-delay = 
    .label = Descarregar abas após
zen-tabs-unloader-unload-delay-description = O tempo em minutos após o qual as abas serão descarregadas
pane-zen-pinned-tab-manager-title = Guias fixadas
zen-pinned-tab-manager-header = Configurações gerais para abas fixadas
zen-pinned-tab-manager-description = Gerenciar comportamento adicional das abas fixadas
zen-pinned-tab-manager-restore-pinned-tabs-to-pinned-url = 
    .label = Restaura as abas fixadas para sua URL originalmente fixada na inicialização
...
zen-settings-workspaces-enabled = 
    .label = Habilitar Área de Trabalho (Experimental)
...
zen-vertical-tabs-newtab-under-last-tab = 
    .label = Mostrar botão de nova aba na última aba
...
zen-search-find-again-shortcut-2 = Localizar novamente (alternativo)
