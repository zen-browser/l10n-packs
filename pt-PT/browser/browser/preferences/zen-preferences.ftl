...
zen-look-and-feel-colors-description = Faça com que o { -brand-short-name } tenha a aparência que prefere
...
zen-side-panels-description = Aumente a produtividade ao ter múltiplas vistas ao mesmo tempo!
zen-side-panels-enabled = 
    .label = Ativar Painéis Web Laterais
zen-side-panels-close-on-blur = 
    .label = Fechar o painel quando ele perde o foco se não estiver fixo
zen-vertical-tabs-show-bottom-border = 
    .label = Mostrar uma borda para os ícones inferiores
