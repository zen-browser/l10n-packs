...
zen-look-and-feel-themed-toolbar = 
    .label = Colorir a barra de ferramentas com a cor de destaque do tema
...
zen-side-panels-close-on-blur = 
    .label = Fechar o painel quando ele perde o foco se não estiver fixado
...
sync-engine-workspaces = 
    ...
    .tooltiptext = Sincronize as suas áreas de trabalho entre dispositivos
    .accesskey = W
...
zen-look-and-feel-buttons-description = Escolha o estilo de botões que deseja ver
zen-look-and-feel-pilled-buttons = 
    .label = Botões em forma de comprimido
...
zen-settings-workspaces-description = Com áreas de trabalho, pode ter várias sessões de navegação ao mesmo tempo!
zen-settings-workspaces-enabled = 
    .label = Habilitar Áreas de Trabalho (Experimental)
...
zen-settings-workspaces-allow-pinned-tabs-for-different-workspaces = 
    .label = Permitir que áreas de trabalho tenham os seus próprios separadores fixados
zen-key-unsafed = Atalho não guardado! Por favor, proteja-o clicando na tecla "Escape" depois de o voltar a inserir.
...
zen-settings-workspaces-force-container-tabs-to-workspace = 
    .label = Mudar para área de trabalho onde o contentor é definido como padrão ao abrir separadores de contentor
