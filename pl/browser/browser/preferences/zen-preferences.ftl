...
zen-look-and-feel-themed-toolbar = 
    .label = Uczyń pasek narzędziowy motywowany kolorem akcentu
...
zen-side-panels-enabled = 
    .label = Włącz panel strony internetowej
zen-side-panels-close-on-blur = 
    .label = Zamknij panel, gdy traci ostrość jeśli nie jest przypięty
...
zen-look-and-feel-pilled-buttons = 
    .label = Przyciski obluzowane
pane-zen-tabs-title = Zarządzanie zakładkami
...
zen-tabs-unloader-description = Automatycznie rozładuj nieużywane zakładki, aby zapisać pamięć
zen-tabs-unloader-enabled = 
    .label = Włącz rozładowywanie kart
zen-tabs-unloader-unload-delay = 
    .label = Wyładuj karty po
...
zen-pinned-tab-manager-close-shortcut-behavior-label = Zamknij zachowanie skrótu karty
...
zen-key-unsafed = Niezapisany skrót! Proszę zabezpieczyć go klikając przycisk "Escape" po ponownym wpisaniu.
...
zen-vertical-tabs-newtab-under-last-tab = 
    .label = Pokaż nowy przycisk zakładki pod ostatnią kartą
...
zen-theme-marketplace-updates-fail = Nie można znaleźć żadnych aktualizacji!
...
zen-settings-workspaces-display-as-icon-strip = 
    .label = Wyświetl projekt jako pasek ikon
...
zen-settings-workspaces-hide-deactivated-workspaces = 
    .label = Ukryj zdezaktywowane projekty
...
zen-split-view-title = Podziel widok
zen-split-view-header = Podziel widok
zen-split-view-description = Podziel swoją przeglądarkę na wiele widoków, umożliwiając przeglądanie wielu stron na raz
zen-split-view-change-on-hover = 
    .label = Zmień zakładki po najechaniu kursorem
...
zen-web-panel-shortcut-toggle = Przełącz panel internetowy
