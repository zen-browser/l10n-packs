...
zen-dark-theme-styles-description = Kohanda tume teema endale meelepäraseks
...
zen-split-view-change-on-hover = 
    .label = Lülitu kaartide vahel hiirekursoriga nende peale liikumisel
...
zen-settings-CKS-description = Muuda vaikimisi klaviatuuri otseteed endale meelepäraseks ning paranda veebisirvimise kogemust
