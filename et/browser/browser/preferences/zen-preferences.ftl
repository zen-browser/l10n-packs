...
zen-pinned-tab-manager-reset-unload-switch-close-shortcut-option = 
    .label = Lähtesta URL, eemalda mälust ja vaheta järgmisele kaardile
zen-pinned-tab-manager-unload-switch-close-shortcut-option = 
    .label = Eemalda mälust ja vaheta järgmisele kaardile
zen-pinned-tab-manager-reset-switch-close-shortcut-option = 
    .label = Lähtesta URL ja vaheta järgmisele kaardile
zen-pinned-tab-manager-switch-close-shortcut-option = 
    .label = Vaheta järgmisele kaardile
...
zen-key-unsafed = Salvestamata otsetee! Salvetamiseks kasuta "Esc" klahvi pärast otsetee sisestamist.
...
zen-vertical-tabs-newtab-top-button-border = 
    .label = Kuva eraldavat joont kui uue kaardi nupp on lõpus
...
zen-theme-marketplace-updates-fail = Ei leitud ühtegi uuendust!
...
zen-settings-workspaces-display-as-icon-strip = 
    .label = Kuva tööruumid ikooniribana
...
zen-settings-workspaces-hide-deactivated-workspaces = 
    .label = Peida välja lülitatud tööruumid
...
zen-split-view-title = Jaotatud vaade
zen-split-view-header = Jaotatud vaate funktsionaalsus
zen-split-view-description = Jaota oma brauser mitmeks vaateks, mis võimaldab sirvida mitut veebilehte korraga
zen-split-view-change-on-hover = 
    .label = Vaheta kaarte hiirekursoriga peale liikumisel
...
zen-print-shortcut = Prindi leht
...
zen-web-panel-shortcut-toggle = Lülita veebipaneel sisse/välja
