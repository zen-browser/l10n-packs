...
pane-zen-tabs-unloader-title = Giải phóng thẻ
zen-tabs-unloader-header = Cài đặt chung cho giải phóng thẻ
zen-tabs-unloader-description = Tự động giải phóng thẻ để tiết kiệm bộ nhớ
zen-tabs-unloader-enabled = 
    .label = Mở giải phóng thẻ
zen-tabs-unloader-unload-delay = 
    .label = Giải phóng thẻ sau
zen-tabs-unloader-unload-delay-description = Thời gian ở phút các thẻ sẽ bị giải phóng khi không sử dụng
...
zen-theme-disable-all-enabled = 
    .title = Vô hiệu hóa tất cả các chủ đề
zen-theme-disable-all-disabled = 
    .title = Kích hoạt tất cả các chủ đề
...
zen-theme-marketplace-import-button = 
    .label = Nhập các tinh chỉnh
zen-theme-marketplace-export-button = 
    .label = Xuất các tinh chỉnh
zen-theme-marketplace-import-success = Các tinh chỉnh được cập nhật thành công
zen-theme-marketplace-import-failure = Có lỗi xảy ra khi nhập các tinh chỉnh
zen-theme-marketplace-export-success = Các tinh chỉnh được xuất thành công
zen-theme-marketplace-export-failure = Có lỗi xảy ra khi xuất các tinh chỉnh
zen-theme-marketplace-updates-success = Chủ đề được cập nhật thành công
zen-theme-marketplace-updates-failure = Không tìm được bản cập nhật nào!
zen-theme-marketplace-toggle-enabled-button = 
    .title = Tắt các tinh chỉnh
zen-theme-marketplace-toggle-disabled-button = 
    .title = Bật các tinh chỉnh
zen-theme-marketplace-remove-confirmation = Bạn có chắc muốn xóa tinh chỉnh này không?
...
zen-full-zoom-enlarge-shortcut-alt = Zoom vào (Alt)
zen-full-zoom-enlarge-shortcut-alt2 = Zoom vào (Alt 2)
